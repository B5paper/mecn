...
上图是高频功率放大器的原理图。*有个问题：书上说静态时发射结要反偏，为啥这里的发射结看上去没有反偏？*
...
*   集电极效率$\eta_c$
    ...
    其中电压利用系数$$\xi = \frac{U_c}{E_c}$$，电流利用系数$$\gamma = \frac {I_{c1}}{I_{c0}}$$
...
![power_amplifier_1_2](pictures/chapter_3/power_amplifier_1_2.png)
