...
![series resonance circuit](picture/高频电路原理与分析/series resonance circuit.jpg)
...
![equivalent parallel oscillator](picture/高频电路原理与分析/equivalent parallel oscillator.jpg)
...
![impedance modulus vs omega in parallel resonance circuit](picture/高频电路原理与分析/impedance modulus vs omega in parallel resonance circuit.jpg)
...
![impedance modulus vs omega in practiced parallel resonance circuit](picture/高频电路原理与分析/impedance modulus vs omega in practiced parallel resonance circuit.jpg)
...
![double capacitive divider circuit](picture/高频电路原理与分析/double capacitive divider circuit.png)
...
![experiment 1 of double capacitive divider circuit](picture/高频电路原理与分析/experiment 1 of double capacitive divider circuit.png)
...
![experiment 2 of double capacitive divider circuit](picture/高频电路原理与分析/experiment 2 of double capacitive divider circuit.png)

从bode图里我们看到，随着频率的升高，$C_2$上的电压上升到了一个稳定的值。

### 电感抽头分压电路

![tap inductor circuit](picture/高频电路原理与分析/tap inductor circuit.png)
...
![experiment 1 of tap inductor circuit](picture/高频电路原理与分析/experiment 1 of tap inductor circuit.png)

（需要注意的是，电路中必须要加一个开关才能正常仿真，不然会提示说 matrix is singular之类的）

画出的波特图是这样的：

![experiment 1 of tap inductor circuit result](picture/高频电路原理与分析/experiment 1 of tap inductor circuit result.png)
...
![tap parallel resonance circuit 1](picture/高频电路原理与分析/tap parallel resonance circuit 1.png)

上图即是一个用双电容分压的，带有谐振性质的回路。

我们用仿真软件测试一下它的性能和只有双电容分压的电路有何不同：

![tap parallel resonance circuit 2](picture/高频电路原理与分析/tap parallel resonance circuit 2.png)

![tap parallel resonance circuit 3](picture/高频电路原理与分析/tap parallel resonance circuit 3.png)
...
![tap parallel resonance circuit 4](picture/高频电路原理与分析/tap parallel resonance circuit 4.png)

![tap parallel resonance circuit 5](picture/高频电路原理与分析/tap parallel resonance circuit 5.png)
...
![IMG_20170921_174916](picture/高频电路原理与分析/IMG_20170921_174916.jpg)
...
![coupled two-resonator circuit](picture/高频电路原理与分析/coupled two-resonator circuit.png)

电路中的$C_{12}$起到了耦合的作用。

耦合振荡回路的相关参数推导很麻烦，只需要记住有个**耦合因数h**（书上是A）就可以了。![coupled two-resonator circuit](picture/高频电路原理与分析/coupled two-resonator circuit feature.png)
